CXX = g++
CXXFLAGS = -std=c++11 -Wall -Wextra -fdiagnostics-color=always -g -Wno-unused-function -Wno-unused-variable
...
$(EXEC): $(OBJS)
	$(CXX) $(CXXFLAGS) $(INCLUDES) $(LIBSDIRS) $(OBJS) $(LIBS) -o build/$(EXEC)
%.o: %.cpp
