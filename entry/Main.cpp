...
int main()
{
    ...
    Mesh* mesh2 = MeshParser::parseMesh("./resources/meshes/untitled.obj",sh);
    mesh->scale(glm::vec3(0.2f,0.2f,0.2f));
    mesh->translate(glm::vec3(1.0f,0.0f,0.0f));
    mesh2->translate(glm::vec3(1.0f,0.0f,0.0f));
